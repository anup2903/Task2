...
import { useData } from "@src/components/contexts/DataContext";
...
const PreviewCard: React.FC = ({formData1,formData2,formData3}) => {
      ...
      <Box borderRadius="10px" bgColor="gray.100" height="fit-content">
        ...
        <Box w="100%" p="16px 24px">
          ...
          >
            <Flex
              ...
              alignItems="center"
            >
              <Text fontSize="0.9rem" fontWeight="500">{formData.requisitionTitle}</Text>
              <Flex justifyContent="space-around" alignItems="center">
                <Text fontSize="0.8rem" mr="0.4rem" fontWeight="200" as="p">
                  OPENINGS
                </Text>
                <Text fontSize="1rem" fontWeight="bold" as="span">{formData1.noOfOpenings}</Text>
              </Flex>
            </Flex>
          </Box>
        </Box>
        <Box maxH="50rem" overflowY="auto" px="24px" pb="24px">
          <DataCard title="Requisition Details">
            ...
            <KeyValue title="Urgency" value={formData1.urgency} />
            <KeyValue title="Gender" value={formData1.gender} />
          </DataCard>
